...
!function(e, t) {
  ...
  HistoryController.prototype = {
    ...
    getCls: function(e) {
      ...
      return {
        beforeShow: r + "-before-show " + t + "-before-show",
        show: r + "-show " + t + "-show",
        beforeHide: r + "-before-hide " + t + "-before-hide",
        hide: r + "-hide " + t + "-hide"
      };
    },
    clearCls: function(e) {
  ...
  return Pjax.prototype = $.extend({
    ...
    _addContent: function(e, t, r) {
      ...
      if (e.$dom && 1 === e.$dom.length) {
        n.$root.append(e.$dom);
        var o = e.$dom, a = n.$root.find("[" + n.keyCurrent + "]");
        i.addScripts(e.scripts, function() {
          n.fire("pjax:render", [ o ]), n.fire("dom:ready", [ o ]);
        }), i.addLinks(e.links), n.fire("dom:beforeshow", [ o ]), n.fire("dom:beforehide", [ a ]), 
        n.clsCtrl.animate(t || "replace", a, o, function() {
